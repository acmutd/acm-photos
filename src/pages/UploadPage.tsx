    ...
    return (
        <div className="mx-auto w-full max-w-4xl px-6 py-10">
            <div className="flex items-start justify-between gap-4">
                ...
                <Link to="/media" className="text-xs text-muted-foreground hover:text-foreground transition">
                    Back to media
                </Link>
            </div>
            ...
            <div className="mt-6 grid gap-4">
                ...
                <div className="rounded-xl border border-border bg-card p-4">
                    <div className="mb-2 h-1.5 w-16 rounded-full bg-acm-gradient"/>
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                        <div>
                            <div className="text-sm font-semibold">Destination</div>
                            <div className="mt-1 text-xs text-muted-foreground">
                                Later this will be a folder picker; for now you can paste a folder id.
                            </div>
                        </div>
                ...
                <div className="rounded-xl border border-border bg-card p-4">
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                        <div>
                            ...
                            <div className="mt-1 text-xs text-muted-foreground">
                                These will be applied to every uploaded item (you can edit per-item later).
                            </div>
                        </div>
                ...
                <div className="rounded-xl border border-border bg-card p-4">
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                        <div>
                            ...
                            <div className="mt-1 text-xs text-muted-foreground">
                                Choose one or more files (photos/videos). Upload button is wired later.
                            </div>
                        </div>
                            ...
                            <div className="mt-2 max-h-40 overflow-auto">
                                <ul className="flex flex-col gap-1 text-sm">
                                    {selectedFiles.slice(0, 25).map((f) => (
                                        <li key={`${f.name}-${f.size}`} className="truncate text-muted-foreground">
                                            {f.name}{' '}
                ...
                <div className="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
                    ...
                    <button
                        ...
                        className="h-10 rounded-md bg-acm-gradient px-4 text-sm font-medium text-primary-foreground opacity-60"
                        title="Wiring soon"
                    >
                        Upload (soon)
                    </button>
